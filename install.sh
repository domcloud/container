...
# Tools
dnf -y install btop certbot clang cmake gcc-c++ git ncdu htop iftop ipset jq lsof make nano ncurses nodejs rsync socat strace tar time tmux vim wget whois xz yarn zstd \
